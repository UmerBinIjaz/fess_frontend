  ...
  return (
    <div className={`min-h-screen bg-gray-100 flex flex-col justify-center sm:py-12 ${darkMode ? "bg-dallas-cowboys-blue" : "bg-white"}`}>
      ...
      <div className="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
        <h1 className={`font-bold text-center text-2xl mb-5 ${darkMode ? "text-white" : "text-gray-700"}`}>Reset Password</h1>
      ...
      <div className="py-5 text-center">
        <span className={`text-sm ${darkMode ? "text-white" : "text-gray-700"}`}>
          ...
          <a href="/teacher/login" className={`${darkMode ? "text-white hover:text-gray-400" : "text-blue-500 hover:text-blue-700"}`}>
            Login
          </a>
        </span>
      </div>
