...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    const success = await login('admin', email, password); // Replace with dynamic role if needed
        ...
        <div className={`shadow w-full rounded-lg divide-y divide-gray-200 ${darkMode ? "bg-college-navy" : "bg-white"}`} >
            ...
            <div className="grid grid-cols-2 gap-1">
              <div className="text-center sm:text-left whitespace-nowrap">
                <button className="transition duration-200 mx-5 px-5 py-4 cursor-pointer font-normal text-sm rounded-lg text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-200 focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50 ring-inset">
                  ...
                  <a href="/admin/forgot-password/"><span className="inline-block ml-1">Forgot Password</span></a>
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="py-5 text-center">
            <span className={`text-sm ${darkMode ? "text-white" : "text-gray-700"}`}>
              ...
              <a href="/admin/register" className={`${darkMode ? "text-white hover:text-gray-400" : "text-blue-500 hover:text-blue-700"}`}>
                Register
              </a>
            </span>
          </div>
